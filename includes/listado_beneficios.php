...
<style>
    ...
    /* Reseteo scoped solo para el componente y sus hijos directos/indirectos */
    .swiss-benefits-module,
    .swiss-benefits-module * {
    ...
    /* Caja contenedora sin estilos que comprometan el fondo global de la página */
    ...
    /* Layout horizontal deslizable */
    .swiss-benefits-module .swiss-benefits-scrollrow {
        display: flex;
        gap: 32px;
        overflow-x: auto;
        padding-bottom: 30px;
    ...
    /* Scrollbar premium estilizado */
    .swiss-benefits-module .swiss-benefits-scrollrow::-webkit-scrollbar {
        height: 6px;
    }
    .swiss-benefits-module .swiss-benefits-scrollrow::-webkit-scrollbar-track {
        background: transparent;
    }
    .swiss-benefits-module .swiss-benefits-scrollrow::-webkit-scrollbar-thumb {
        background: rgba(0, 0, 0, 0.12);
        border-radius: 10px;
    }
    .swiss-benefits-module .swiss-benefits-scrollrow::-webkit-scrollbar-thumb:hover {
        background: rgba(0, 0, 0, 0.25);
    }

    /* Tarjetas Minimalistas de Beneficios */
    ...
    .swiss-benefits-module .swiss-benefit-card:hover {
        transform: translateY(-4px);
        background-color: #fcfcfc;
        box-shadow: 0 20px 40px rgba(0,0,0,0.03);
    }

    .swiss-benefits-module .swiss-sphere-wrapper {
        position: relative;
        height: 180px;
        display: flex;
...
<div class="swiss-benefits-module">
    <div class="swiss-outer-canvas">
        ...
        <nav class="swiss-category-bar" aria-label="Categorías de beneficios">
            <?php foreach ($categorias_beneficios as $indice => $categoria) : ?>
                <button 
                    class="swiss-category-btn <?php echo $indice === 0 ? 'is-active' : ''; ?>" 
                    data-index="<?php echo $indice; ?>"
                    type="button"
                >
                    <?php echo $escapar_html($categoria['titulo']); ?>
                </button>
            <?php endforeach; ?>
        </nav>

        <!-- Contenedor dinámico de beneficios (Viewport) -->
        <div class="swiss-benefits-viewport">
            <div class="swiss-benefits-scrollrow" id="swiss_benefits_container">
                <!-- Los beneficios se inyectan dinámicamente con JS de forma idéntica a la referencia -->
            </div>
        </div>
